...
![Jenkins-Install-Blue-Ocean-Plugin](Jenkins-Install-Blue-Ocean-Plugin-SCR-20231014-labg.png)

1. From the homepage of your Jenkins server, select **Manage Jenkins**.
2. Select **Plugins**.
